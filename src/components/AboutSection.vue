    ...
    <section class="text-white mt-10 scroll-mt-24" id="about">
        ...
        <div class="md:grid md:grid-cols-2 gap-8 items-center py-8 px-4 xl:gap-16 sm:py-16 xl:px-16 z-1">
            <div class="mt-4 md:mt-0 text-left flex flex-col z-10 h-full" data-aos="flip-right">
                <h2 class="text-3xl font-bold text-white md:text-center text-left mb-4">
                    <span class="text-transparent bg-clip-text bg-gradient-to-r from-orange-900 to-red-300">
                    History Company
                    </span>
                </h2>
                ...
                <div class="grid grid-cols-3 gap-4 max-w-lg pt-8">
                    <div class="text-center rounded-xl bg-[#1a2456] dark:bg-[#111a3e] shadow-lg border border-[#1f1641] p-3">
                        ...
                        <p class="text-sm sm:text-base text-grey-300">Partner</p>
                    </div>
                    <div class="text-center rounded-xl bg-[#1a2456] dark:bg-[#111a3e] shadow-lg border border-[#1f1641] p-3">
                        <h3 class="text-white font-bold text-xl sm:text-2xl lg:text-3xl">+100</h3>
